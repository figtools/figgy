...
locals {
  write_cw_logs_policy_arn = var.primary_region ? aws_iam_policy.figgy_write_cw_logs.arn :"arn:aws:iam::${data.aws_caller_identity.current.account_id}:policy/${local.config_auditor_name}",
}
